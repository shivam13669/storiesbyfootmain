        ...
        >
          ...
          >
            ...
            >
              ...
              />
              {/* Body */}
              <rect x="45" y="65" width="30" height="30" rx="5" className="fill-secondary/70" />
              {/* Arms */}
              <rect x="20" y="70" width="25" height="8" rx="4" className="fill-primary/60" />
              <rect x="75" y="70" width="25" height="8" rx="4" className="fill-primary/60" />
              {/* Legs */}
              <rect x="48" y="95" width="8" height="20" rx="4" className="fill-primary/70" />
              <rect x="64" y="95" width="8" height="20" rx="4" className="fill-primary/70" />
            </motion.svg>
          </motion.div>
