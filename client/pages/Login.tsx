                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            ...
                            className={`w-full pl-11 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 bg-gray-50/50 transition-all ${emailError ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200 focus:border-orange-500'
                              }`}
                            required
                          />
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group" onMouseDown={() => setIsPasswordFieldFocused(false)}>
                          ...
                          <Input
                            ...
                            className={`w-full pl-11 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 bg-gray-50/50 transition-all ${signupEmailError ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200 focus:border-orange-500'
                              }`}
                            required
                          />
                        </div>
                        ...
                        <div className="flex gap-2" onMouseDown={() => setIsPasswordFieldFocused(false)}>
                                  ...
                                  {filteredCountries.length > 0 ? (
                                    filteredCountries.map((country) => (
                                      <button
                                        ...
                                        className={`w-full text-left px-3 py-2.5 text-sm hover:bg-orange-50 transition-colors flex items-center justify-between ${selectedCountry.code === country.code ? "bg-orange-100 font-semibold" : ""
                                          }`}
                                      >
                                        <span>
                          ...
                          <div className="relative group flex-1">
                            ...
                            <Input
                              ...
                              className={`w-full pl-11 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 bg-gray-50/50 transition-all ${mobileNumberError ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200 focus:border-orange-500 focus:ring-orange-500/20'
                                }`}
                              required
                            />
                          </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group" onMouseDown={() => setIsPasswordFieldFocused(false)}>
                          ...
                          <Input
                            ...
                            className={`w-full pl-11 pr-12 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 bg-gray-50/50 transition-all ${confirmPassword && !passwordsMatch ? 'border-red-400 focus:border-red-500' : 'border-gray-200 focus:border-orange-500'
                              }`}
                            required
                          />
                          <button
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className={`w-full pl-11 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 bg-gray-50/50 transition-all ${forgotPasswordEmailError ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200 focus:border-orange-500'
                          }`}
                        required
                      />
                    </div>
